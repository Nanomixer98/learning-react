...
export const InstagromApp = () => {
  ...
  const handleAddComment = async (formData: FormData) => {
    const messageTxt = formData.get('post-message') as string;
    console.log('Nuevo comentario', messageTxt);
    addOptimisticComment(messageTxt);
    startTransition(async () => {
      ...
      toast.error('Error when adding the comment', {
