...
export const TrafficLightWithHook = ({ countdownDuration = 5 }: Props) => {
  const { countdown, progressPercentage, redLight, yellowLight, greenLight } =
    useTrafficLight(countdownDuration);
